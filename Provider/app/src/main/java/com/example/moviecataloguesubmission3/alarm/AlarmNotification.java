...
import static com.example.moviecataloguesubmission3.alarm.AlarmReceiver.ID_DAILY_REMINDER;
import static com.example.moviecataloguesubmission3.alarm.AlarmReceiver.ID_RELEASE_REMINDER;
import static com.example.moviecataloguesubmission3.alarm.AlarmReceiver.ID_RELEASE_REMINDER_DIFF;
...
public class AlarmNotification {
    static void showDailyReminderNotification(Context context) {
        ...
        String message = context.getString(R.string.daily_notif);
    ...
    public static void onReceiveReleaseToday(Context context, ArrayList<Movie> items) {
        for (int i = 0; i < items.size(); ++i) {
            String title = items.get(i).getTitle();
            String message = String.format(context.getString(R.string.release), title);
